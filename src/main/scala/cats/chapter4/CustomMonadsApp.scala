...
object CustomMonadsApp extends App {
  ...
  def retryTailRecTree[F[_]: Monad, A](start: A)(f: A => F[A]): F[A] =
  ...
  println(retryTailRecTree[Tree, Int](100000)(a => if (a == 0) Leaf(a) else Leaf(a - 1)))
